...
public final class NetURL {
	...
	public static final String getApi() {
		final int[] SERVER_USRS = {R.string.uattest_server, R.string.offical_server, R.string.local_server};
...
//	public static final String		IDENTITY_PROTOCOL		= "http://m.scity.cn/appstore/html/510100_IdentityProtocol.html";		// 实名认证协议
	...
	public static final String[]	CACHE_URL				= {ALL_APP, PUSH_SERVICE_, PUSH_MORE_SERVICE, ALL_SERVICE_COLUMN};
}
