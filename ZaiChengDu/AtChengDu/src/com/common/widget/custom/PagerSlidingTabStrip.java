...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorPaddingValue = 55;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		tabTextSize = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_dwTabTextSize, tabTextSize);
		tabTextColor = a.getColor(
				R.styleable.PagerSlidingTabStrip_dwTabTextColor, tabTextColor);
		selectedTabTextSize = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_dwSelectedTabTextSize,
				selectedTabTextSize);
		selectedTabTextColor = a.getColor(
				R.styleable.PagerSlidingTabStrip_dwSelectedTabTextColor,
				indicatorColor);
	...
	protected void onDraw(Canvas canvas) {
		...
		float lineLeft = currentTab.getLeft() + indicatorPaddingValue;
		float lineRight = currentTab.getRight() - indicatorPaddingValue;
		...
		if (currentPositionOffset > 0f && currentPosition < tabCount - 1) {
			...
			final float nextTabLeft = nextTab.getLeft() + indicatorPaddingValue;
			final float nextTabRight = nextTab.getRight()
					- indicatorPaddingValue;
