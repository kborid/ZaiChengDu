...
public class SessionContext {
    ...
    private static List<NewsListBean.NewsItemBean> mNewsList;                // 新闻缓存
    ...
    public static void setNewsList(List<NewsListBean.NewsItemBean> list) {
        mNewsList = list;
    }

    public static List<NewsListBean.NewsItemBean> getNewsList() {
        if (null == mNewsList) {
