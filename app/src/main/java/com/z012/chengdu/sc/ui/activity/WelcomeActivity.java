...
import com.z012.chengdu.sc.ui.permission.PermissionsActivity;
import com.z012.chengdu.sc.ui.permission.PermissionsChecker;
...
public class WelcomeActivity extends BaseActivity implements DataCallback {
    ...
    private static class WorkerAsyncTask extends AsyncTask<Void, Void, Void> {
        private WeakReference<WelcomeActivity> ref = null;
