...
public class QAPicturesAdapter extends BaseAdapter {
    ...
    public QAPicturesAdapter(Context context, ArrayList<String> mBean) {
        ...
        if (size == 2 || size == 4) {
            ...
            ((QADetailsActivity) mContext).mQAGridView.setLayoutParams(new LinearLayout.LayoutParams(ScreenUtils.dp2px(151), LayoutParams.WRAP_CONTENT));
        } else if (size == 1) {
        ...
        if (convertView == null) {
            switch (type) {
                case TYP1:
                    ...
                    params.height = ScreenUtils.dp2px(150);
                    params.width = ScreenUtils.dp2px(150);
