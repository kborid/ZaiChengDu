...
//                        }
    ...
    public void requestBanner() {
        HashMap<String, Object> params = RequestBuilder.create(false)
                ...
                .build();
        ApiManager.getBanner(params, new ObserverImpl<ResponseComm<BannerListBean>>() {
            @Override
            public void onNext(ResponseComm<BannerListBean> o) {
                super.onNext(o);
                Logger.t(TAG).d(o.bodyToString());
                banner_lay.setImageResource(o.getBody().getDatalist());
            }
        });
    }
    ...
    private void requestNews() {
        ApiManager.getNews(RequestBuilder.create(false).build(), new ObserverImpl<ResponseComm<NewsListBean>>() {
            @Override
            public void onNext(ResponseComm<NewsListBean> o) {
                super.onNext(o);
                Logger.t(TAG).d(o.bodyToString());
    ...
    private void requestWeather() {
        HashMap<String, Object> params = RequestBuilder.create(false)
                ...
                .build();
        ApiManager.getWeather(params, new ObserverImpl<ResponseComm<WeatherInfoBean>>() {
            @Override
            public void onNext(ResponseComm<WeatherInfoBean> o) {
                super.onNext(o);
                Logger.t(TAG).d(o.bodyToString());
