...
import com.z012.chengdu.sc.event.TabChangeEvent;
...
public class TabServerFragment extends BaseFragment {
    ...
    private View getPlaceHolderView() {
        ...
        llp.height = ScreenUtils.mScreenHeight - mScrollViewY - ScreenUtils.dp2px(100);
...
//                        tabs.getTabAt(i).select();
    ...
    public void getAllServices() {
        ...
        ApiManager.getAllServices(RequestBuilder.create(false).build(), new ResponseCallback<AllServiceListBean>() {
            @Override
            public void onSuccess(AllServiceListBean o) {
    ...
    private void refreshServiceLayout() {
        ...
        for (int i = 0; i < mCatalogBean.size(); i++) {
            ...
            if (i > 0) {
                view.setPadding(0, ScreenUtils.dp2px(24), 0, 0);
            } else {
