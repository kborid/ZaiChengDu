package com.z012.chengdu.sc.ui.activity.address;
...
import com.z012.chengdu.sc.net.entity.UserAddrs;
...
public class AddressEditActivity extends BaseActivity implements
    ...
    public void dealIntent() {
        ...
        if (getIntent().getExtras() != null) {
            ...
            String sb = temp.province + "-" + temp.city + "-" + temp.area;
    ...
    private void submitData() {
        ...
        if (StringUtil.empty(name)) {
            ToastUtil.show("联系人不允许为空", 0);
            return;
        }
        if (StringUtil.empty(phone)) {
            ToastUtil.show("联系电话不允许为空", 0);
            return;
        }
