...
public class TabUserFragment extends BaseFragment {
    ...
    protected void initParams() {
        ...
        llp.width = ScreenUtils.mScreenWidth;
    ...
    public void loadValidateTicketExpire() {
        ...
        ApiManager.getTicketValid(RequestBuilder.create(true).build(), new ResponseCallback<ResponseComm<Object>>() {
            @Override
            public void onSuccess(ResponseComm<Object> o) {
